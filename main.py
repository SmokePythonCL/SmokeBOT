...
#from discord_slash import SlashCommand Can't make it compatible with nextcord yet.


# Read the prefix for the servers
def get_prefix(bot, message):
    with open('../NextcordBOT/json/prefixes.json', 'r') as f:
        prefixes = json.load(f)

    return prefixes[str(message.guild.id)]


intents = nextcord.Intents(members=True, messages=True, guilds=True)
...
async def on_guild_join(guild):
    ...
    with open('../NextcordBOT/json/prefixes.json', 'w') as f:
